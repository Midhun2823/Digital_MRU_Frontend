                    ...
                    <div>
                        ...
                        <div className="row">
                            <div className="col-md-12 p-5 row">
                                ...
                                <h1 className="col-md-8 display-6">
                                    +91 6300188045
                                </h1>
                        ...
                        MRUH (B.Tech CSE 3<sup>rd</sup> Year)
                                            ...
                                            <p class="card-text lead">
                                                Java | MERN | DSA | Python |
                                                Android | Angular | HTML | CSS |
                                                Bootstrap | JavaScript | Jetpack
                                                Compose
                                            </p>
                                            <span>
                                                <img
